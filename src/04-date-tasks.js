...
function angleBetweenClockHands(/* date */) {
  ...
  //   hours = hours - 12;
  // }
  // const hourAngle = 0.5 * (60 * hours + someDate.getUTCMinutes());
  // const minuteAngle = degreesPerMinute * someDate.getUTCMinutes();
  // let angleBetweenClock = Math.abs(hourAngle - minuteAngle);
  // if (angleBetweenClock > 180) {
  //   angleBetweenClock = 360 - angleBetweenClock;
  // }
  // const radians = (angleBetweenClock * Math.PI) / 180;
  // return radians;
}
